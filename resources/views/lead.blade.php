...
<div class="contents">
    <div class="content-title">
        <div>
            <h4>Leads Info <span class="badge">{{ count($leadAll) }}</span></h4>
        </div>
        <div class="w-50">
    ...
    <div class="content-detail mt-5">
        <div class="row">
            ...
            <div class="col-lg-3 d-flex justify-content-center lead mb-5">
                <div class="profile-card">
                    <div class="hover-box">
                        ...
                        <div class="down">
                            ...
                            @csrf
                            @method('PUT')
                                <button>Convert Client</button>
                            </form>                           
                        </div>
                    </div>
                    <div class="card-border-top"></div>
                    <div class="img">
                        <img src="../images/{{ $lead->image }}" alt="">
                    </div>
                    <span>{{ $lead->name }}</span>
                    <p class="info first"><i class="fa-light fa-briefcase"></i> <span>{{ $lead->job_title }}</span></p>
                    <p class="info"><i class="fa-light fa-envelope"></i> <span>{{ $lead->email }}</span></p>
                    <p class="info"><i class="fa-light fa-mobile"></i> <span>{{ $lead->phone_number }}</span></p>
                    <p class="info"><i class="fa-light fa-building-columns"></i> <span>{{ $lead->company }}</span></p>
                </div>
            </div> 
            @endforeach           
        </div>
